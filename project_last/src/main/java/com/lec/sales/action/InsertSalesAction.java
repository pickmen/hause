...
import com.lec.sales.service.InsertSalesService;

public class InsertSalesAction implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		InsertSalesService insertSalesService = new InsertSalesService();
		boolean isSuccessInsert = insertSalesService.insert(sales);
