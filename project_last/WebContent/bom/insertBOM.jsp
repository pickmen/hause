...
<body>
	...
	<form action="/insertBOM.do" method="post">
		<div class="container">
			<div class="row">
		...
		<table class="mx-auto table" style="text-align: center;">
			<tr>
				<th width="20%" class="align-middle">품목명(코드)</th>
			...
			<tr>
				...
				<td><input type="number" name="item_cnt" class="form-control"></td>
			</tr>
			<tr>
				...
				<!-- <td><input name="prt_item_code" class="form-control"></td> -->
			</tr>
		</table>
	<div class="container">
		<div class="row">
